...
export default function RegisterPage() {
    ...
    const googleConnectionId =
        ...
        process.env.KINDE_CONNECTION_GOOGLE ||
        'conn_0195607bb367ae39156fd585d8c1624f';

    const githubConnectionId =
        process.env.NEXT_PUBLIC_KINDE_CONNECTION_GITHUB ||
        process.env.KINDE_CONNECTION_GITHUB ||
        'conn_01955d28c5e61bb11dba9b82ae6c9c2e';

    const emailConnectionId =
        process.env.NEXT_PUBLIC_KINDE_CONNECTION_EMAIL ||
        process.env.KINDE_CONNECTION_EMAIL ||
        googleConnectionId;
                ...
                <Card className="border-[#3b82f6]/20 shadow-2xl bg-transparent backdrop-blur-3xl relative overflow-hidden group">
                    <CardContent className="p-8 space-y-6 relative z-10">
                        ...
                        <div className="flex gap-3 justify-center">
                            <RegisterLink authUrlParams={{ connection_id: googleConnectionId }}>
                                <motion.div
                            ...
                            <RegisterLink authUrlParams={{ connection_id: githubConnectionId }}>
                                <motion.div
                                    whileHover={{ scale: 1.02, y: -2 }}
                                    whileTap={{ scale: 0.98 }}
                                >
