...
export default function ClimateModelInsightPage() {
  return (
            ...
            <Card className="bg-slate-950/90 border border-slate-700/30 p-6">
              ...
              <CardContent className="grid gap-4">
                ...
                <div className="rounded-3xl bg-slate-900/80 p-5">
                  ...
                  <p className="mt-2 text-sm text-slate-400">Classification accuracy for cyclone and coastal risk detection.</p>
                </div>
              </CardContent>
            </Card>
